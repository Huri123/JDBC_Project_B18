...
public class DB_Connection {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        String connectionStr = "jdbc:oracle:thin:@100.26.232.158:1521:XE"; //oracle,sql,mysql olabilir
                                                                          //thin is the oracle driver name. @ den sonraki aws deki IP adres
        String username = "hr" ;
        String password = "hr" ;
...
Statement statement = connection.createStatement(); //use our connection object to createStatement();
// ---> what can we do with this?
       //  ---> we can write our query with this object
// ResultSet object is what we use to store our ACTUAL result from sql(query)
ResultSet resultFromSql = statement.executeQuery("Select * from regions");
//then we can use our object variable to be able to move our cursor
resultFromSql.next(); // cursor pointing to one row and moving to the next
//cursor ---> an arrow pointing to something,
// to be able to move it throughout our list,
// we need to use the next() method on our object,
// once the arrow points to NOTHING it will RETURN A BOOLEAN(true or false)
//In the ResultSet, we have multiple methods to be able to GET the data
// most of the methods are overloaded
// ----> ex: we have getString, which is an overloaded method that returns either 1)index or 2)String
 */
